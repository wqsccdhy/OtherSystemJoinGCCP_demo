...
public class EdocSendRecord extends BaseModel implements Serializable {
    ...
    private String              stepBackAccountName;  //回退单位

    // 客开 项目名称：贵州省政府 ，作者：dengyd，修改日期：2015-5-9 下午3:07:44，功能[转办的公文增加转办意见]，start
    private String              zhuanbanOpinion;

    public String getZhuanbanOpinion() {
        return zhuanbanOpinion;
    }

    public void setZhuanbanOpinion(String zhuanbanOpinion) {
        this.zhuanbanOpinion = zhuanbanOpinion;
    }

    // 客开 项目名称：贵州省政府 ，作者：dengyd，修改日期：2015-5-9 下午3:07:44，功能[转办的公文增加转办意见]，end
    ...
    public String getStepBackAccountName() {
        return stepBackAccountName;
    }

    public void setStepBackAccountName(String stepBackAccountName) {
        this.stepBackAccountName = stepBackAccountName;
    }
